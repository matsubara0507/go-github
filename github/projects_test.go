...
func TestProjectsV2_Marshal(t *testing.T) {
	testJSONMarshal(t, &ProjectsV2{}, "{}")
...
func TestProjectsV2Item_Marshal(t *testing.T) {
	testJSONMarshal(t, &ProjectsV2Item{}, "{}")
	...
	u := &ProjectsV2Item{
		...
		NodeID:        String("n"),
		ProjectNodeID: String("p"),
		ContentNodeID: String("c"),
