...
func TestProjectsV2Event_Marshal(t *testing.T) {
	testJSONMarshal(t, &ProjectsV2Event{}, "{}")

	u := &ProjectsV2Event{
		Project: &ProjectsV2{ID: Int64(1)},
		Action:  String("a"),
		Changes: &ProjectsV2Change{
			Title: &ProjectsV2StringChange{
				From: String("TitleFrom"),
				To:   String("TitleTo"),
			},
			Description: &ProjectsV2StringChange{
				From: String("DescriptionFrom"),
				To:   String("DescriptionTo"),
			},
			ShortDescription: &ProjectsV2StringChange{
				From: String("ShortDescriptionFrom"),
				To:   String("ShortDescriptionTo"),
			},
			Public: &ProjectsV2BoolChange{
				From: Bool(false),
				To:   Bool(true),
			},
		},
	...
	want := `{
		...
		"changes": {
			...
			"short_description": {
				"from": "ShortDescriptionFrom",
				"to": "ShortDescriptionTo"
			},
			"public": {
				"from": false,
				"to": true
...
func TestProjectsV2ItemEvent_Marshal(t *testing.T) {
	testJSONMarshal(t, &ProjectsV2ItemEvent{}, "{}")

	u := &ProjectsV2ItemEvent{
		ProjectItem: &ProjectsV2Item{ID: Int64(1)},
		Action:      String("a"),
		Changes: &ProjectsV2ItemChange{
			ArchivedAt: &ProjectsV2StringChange{
				From: String("ArchivedAtFrom"),
				To:   String("ArchivedAtTo"),
			},
			ContentType: &ProjectsV2StringChange{
				From: String("ContentTypeFrom"),
				To:   String("ContentTypeTo"),
			},
			PreviousProjectsV2ItemNodeId: &ProjectsV2StringChange{
				From: String("PreviousProjectsV2ItemNodeIdFrom"),
				To:   String("PreviousProjectsV2ItemNodeIdTo"),
			},
		},
		Org: &Organization{
			BillingEmail:                         String("be"),
	...
	want := `{
		...
		"changes": {
			...
			"content_type": {
				"from": "ContentTypeFrom",
				"to": "ContentTypeTo"
			},
			"previous_projects_v_2_item_node_id": {
				"from": "PreviousProjectsV2ItemNodeIdFrom",
				"to": "PreviousProjectsV2ItemNodeIdTo"
			}
		},
		"projects_v2_item": {
			"id": 1
